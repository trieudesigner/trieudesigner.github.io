(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.container = $(options.container).length > 0 ? options.container : 'body';
   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 if ($(this.container).find("#" + this.name).length <= 0)
                 {
                     $(this.container).append(this.template);

                    if (this)
                       this.dtpElement = $(this.container).find("#" + this.name);
